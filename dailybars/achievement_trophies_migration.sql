-- ============================================================================
-- DAILY BARS ACHIEVEMENT TROPHIES & UPVOTE TRACKING MIGRATION
...
INSERT INTO trophies (name, description, icon, xp_cost, color, trophy_type, requirement_type, requirement_value) VALUES
-- Bar Count Achievements
('First Bar', 'Created your first bar', '✍️', 0, '#4B5563', 'achievement', 'bars', 1),
('10 Bars Deep', 'Created 10 bars', '🔥', 0, '#EF4444', 'achievement', 'bars', 10),
('50 Bars Strong', 'Created 50 bars', '💪', 0, '#F59E0B', 'achievement', 'bars', 50),
('Century Club', 'Created 100 bars', '💯', 0, '#10B981', 'achievement', 'bars', 100),
('Prolific Writer', 'Created 250 bars', '📝', 0, '#3B82F6', 'achievement', 'bars', 250),
('Oakland Legend', 'Created 500 bars', '👑', 0, '#8B5CF6', 'achievement', 'bars', 500),

-- Streak Achievements
('Streak Starter', '3 day streak', '🔥', 0, '#EF4444', 'achievement', 'streak', 3),
('On Fire', '7 day streak', '🎯', 0, '#F59E0B', 'achievement', 'streak', 7),
('Unstoppable', '14 day streak', '⚡', 0, '#10B981', 'achievement', 'streak', 14),
('Monthly Master', '30 day streak', '🌟', 0, '#FACC15', 'achievement', 'streak', 30),

-- XP Milestones
('XP Rookie', 'Earned 100 XP', '🎖️', 0, '#4B5563', 'achievement', 'xp', 100),
('XP Pro', 'Earned 500 XP', '🏆', 0, '#F59E0B', 'achievement', 'xp', 500),
('XP Legend', 'Earned 1000 XP', '💎', 0, '#8B5CF6', 'achievement', 'xp', 1000),

-- Special Achievements
('Early Adopter', 'Joined Daily Bars', '🚀', 0, '#3B82F6', 'achievement', 'special', 0),
('Community Member', 'Submitted to Syndicate', '🤝', 0, '#10B981', 'achievement', 'special', 0)
