// ============================================================================
// DAILY BARS SERVICE WORKER - v7
// NETWORK-FIRST strategy to fix deployment sync issues
// ============================================================================

const CACHE_NAME = 'daily-bars-v7';
...
self.addEventListener('fetch', (event) => {
  ...
  // 4. NETWORK-FIRST for critical files (HTML, JS, CSS)
  ...
  // 5. CACHE-FIRST for static assets (images, fonts)
  event.respondWith(
