...
const Icon = window.DailyBarsApp?.Icon || (({
  name,
  size = 20
}) => {
...
const ScratchLabView = ({
    ...
    try {
      ...
      if (isTouch || isIOS.current) {
        ...
        try {
          ...
          console.warn('Oscillator kick failed', e);
        }
      }
  ...
  const startRecording = async (startOffset = 0) => {
    ...
    try {
      ...
      mediaRecorder.current.onstop = async () => {
        ...
        const blobOptions = actualMimeType ? {
          type: actualMimeType
        } : undefined;
        ...
        try {
          ...
          if (recordingStartOffset.current > 0) {
            ...
            const newBuffer = audioContext.current.createBuffer(audioBuffer.numberOfChannels, totalSamples, audioBuffer.sampleRate);
  ...
  const handleShiftLayer = (layerId, amount) => {
    setLayers(prev => prev.map(l => {
      ...
      return {
        ...l,
        timeShift: (l.timeShift || 0) + amount
      };
    }));
  };
  ...
  useEffect(() => {
    if (dragState.isDragging) {
      ...
      window.addEventListener('touchmove', handleLayerDragMove, {
        passive: false
      });
      ...
      */
      ...
      for (const layerData of sessionLayers) {
        try {
          ...
          loadedLayers.push({
            id: layerData.id,
            timestamp: new Date(layerData.created_at).toLocaleTimeString([], {
              hour: '2-digit',
              minute: '2-digit'
            }),
  ...
  return /*#__PURE__*/React.createElement("div", {
    style: {
      ...
      // Account for global header and bottom bar
    ...
    name: "Headphones",
    size: 14
  }), /*#__PURE__*/React.createElement("span", null, "Headphones Recommended for Best Quality")), /*#__PURE__*/React.createElement("style", null, `
  ...
  }, "SCRATCH LAB"), isIOS.current && /*#__PURE__*/React.createElement("div", {
    onClick: async e => {
      e.stopPropagation();
      await unlockMobileAudio();
    },
    ...
    cy: "110",
    r: "6",
    fill: isRecording ? "#ff1744" : isPlaying ? "#00e676" : "#455a64",
    className: isRecording || isPlaying ? 'led-blink' : ''
    ...
    height: "60",
    rx: "5",
    fill: isMetronomeOn ? '#4a3f00' : '#2a2218'
  }), /*#__PURE__*/React.createElement("rect", {
    x: "7",
    y: "7",
    width: "52",
    height: "52",
    rx: "4",
    fill: isMetronomeOn ? '#eab308' : '#3a3028'
  }), /*#__PURE__*/React.createElement("text", {
    x: "33",
    y: "30",
    textAnchor: "middle",
    fill: isMetronomeOn ? '#000' : '#d4b896',
    fontSize: "14",
    fontWeight: "900",
    fontFamily: "Arial, sans-serif"
  }, bpm), /*#__PURE__*/React.createElement("text", {
    x: "33",
    y: "48",
    textAnchor: "middle",
    fill: isMetronomeOn ? '#000' : '#a08060',
    fontSize: "11",
    fontWeight: "700",
    fontFamily: "Arial, sans-serif"
  }, "BPM"), /*#__PURE__*/React.createElement("circle", {
    cx: "57",
    cy: "9",
    r: "5",
    fill: isMetronomeOn ? '#fde047' : '#222',
    className: isMetronomeOn ? 'led-blink' : ''
  })), /*#__PURE__*/React.createElement("g", {
    ...
    height: "60",
    rx: "5",
    fill: useCountdown ? '#4a3f00' : '#2a2218'
  }), /*#__PURE__*/React.createElement("rect", {
    x: "7",
    y: "7",
    width: "52",
    height: "52",
    rx: "4",
    fill: useCountdown ? '#eab308' : '#3a3028'
  }), /*#__PURE__*/React.createElement("text", {
    x: "33",
    y: "32",
    textAnchor: "middle",
    fill: useCountdown ? '#000' : '#d4b896',
    fontSize: "13",
    fontWeight: "900",
    fontFamily: "Arial, sans-serif"
  }, "3-2-1"), /*#__PURE__*/React.createElement("text", {
    x: "33",
    y: "50",
    textAnchor: "middle",
    fill: useCountdown ? '#000' : '#a08060',
    fontSize: "11",
    fontWeight: "700",
    fontFamily: "Arial, sans-serif"
  }, "COUNT"), /*#__PURE__*/React.createElement("circle", {
    cx: "57",
    cy: "9",
    r: "5",
    fill: useCountdown ? '#fde047' : '#222',
    className: useCountdown ? 'led-blink-slow' : ''
  }))), /*#__PURE__*/React.createElement("g", {
    ...
    width: "100",
    height: "30",
    fill: countdown > 0 ? "#ff1744" : isPlaying ? "#00e676" : "#455a64",
    opacity: "0.05"
  }), /*#__PURE__*/React.createElement("text", {
    x: "55",
    y: "28",
    ...
    fontWeight: "bold",
    letterSpacing: "2"
  }, countdown > 0 ? `00:0${countdown}` : isPlaying || isScrubbing ? `${progress < 10 ? '0' : ''}${Math.floor(progress / 10)}:${progress % 10}0` : "00:00")), /*#__PURE__*/React.createElement("g", {
    className: `record-group-transition ${isPopped ? 'record-popped' : ''}`
  }, isPopped && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("defs", null, /*#__PURE__*/React.createElement("radialGradient", {
    id: "scrub-glow",
    cx: "50%",
    cy: "50%",
    r: "50%"
  ...
  }), [160, 140, 120, 100, 80].map(r => /*#__PURE__*/React.createElement("circle", {
    key: r,
    cx: "400",
    cy: "300",
    r: r,
  ...
  })), isPopped && /*#__PURE__*/React.createElement("ellipse", {
    cx: "360",
    cy: "260",
    rx: "80",
    ry: "40",
    ...
    fontWeight: "900",
    fontStyle: "italic"
  }, "SCRATCH"), /*#__PURE__*/React.createElement("text", {
    x: "400",
    y: "318",
    fontFamily: "serif",
    fontSize: "14",
    ...
    fontWeight: "900",
    fontStyle: "italic"
  }, "LAB"), /*#__PURE__*/React.createElement("circle", {
    cx: "400",
    cy: "300",
    r: "5",
    fill: "#f5f5f5"
    ...
    d: "M650 200 L 650 440 L 480 470",
    fill: "none",
    stroke: "#424242",
    strokeWidth: "12",
    strokeLinecap: "round"
    ...
    rx: "4",
    fill: "#212121",
    transform: "rotate(-15, 465, 475)"
  }))), !hasStarted && !isRecording && !isPopped && /*#__PURE__*/React.createElement("div", {
    style: {
      position: 'absolute',
      inset: 0,
      display: 'flex',
  ...
  }, "Press Start")), isPopped && !isScrubbing && !showScrubActions && /*#__PURE__*/React.createElement("div", {
    style: {
      position: 'absolute',
      top: '85%',
  ...
  }, "Drag to Scrub \u2022 Tap to Close"), isScrubbing && sessionDuration > 0 && /*#__PURE__*/React.createElement("div", {
    style: {
      position: 'absolute',
      top: '10%',
      left: '50%',
  ...
  }, formatScrubTime(scrubPosition)), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 8,
  ...
  }, scrubVelocity.current > 0.5 ? '⚡ FAST SEEK' : 'FINE CONTROL')), showScrubActions && /*#__PURE__*/React.createElement("div", {
    style: {
      position: 'absolute',
      top: '50%',
      left: '50%',
  ...
  }, "of ", formatScrubTime(sessionDuration)), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      flexDirection: 'column',
      gap: 10
    ...
    name: "Play",
    size: 16
  }), "Play From Here"), /*#__PURE__*/React.createElement("button", {
    ...
    name: "Mic",
    size: 16
  }), "Record From Here"), /*#__PURE__*/React.createElement("button", {
    ...
    name: "RotateCcw",
    size: 14
  }), "Reset to Start"), /*#__PURE__*/React.createElement("button", {
  ...
  }, "Tap outside to close"))))), /*#__PURE__*/React.createElement("main", {
    style: {
      flex: 1,
      overflowY: 'auto',
      padding: '16px 24px',
  ...
  }, liveWaveform.map((h, i) => /*#__PURE__*/React.createElement("div", {
    key: i,
    style: {
      flex: 1,
      background: '#ff5252',
  ...
  }, "Recording...")), layers.length === 0 && !isRecording && /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      flexDirection: 'column',
      alignItems: 'center',
  ...
  }, "Studio rack cleared. Tap record to begin.")), beat && beatWaveform && /*#__PURE__*/React.createElement("div", {
    style: {
  ...
  }, beat), beatWaveform.map((h, i) => /*#__PURE__*/React.createElement("div", {
    key: i,
    style: {
      flex: 1,
      borderRadius: 2,
  ...
  })), (isPlaying || isScrubbing || showScrubActions) && /*#__PURE__*/React.createElement("div", {
    style: {
      position: 'absolute',
      top: 0,
      bottom: 0,
    ...
    name: "Trash2",
    size: 14
  })))), layers.map((layer, index) => /*#__PURE__*/React.createElement("div", {
    key: layer.id,
    style: {
      background: 'rgba(255,255,255,0.95)',
      borderRadius: 12,
  ...
  }, layers.length - index), /*#__PURE__*/React.createElement("span", {
    style: {
      fontSize: 6,
      color: 'var(--gray)',
      fontFamily: 'monospace',
  ...
  }, layer.timestamp)), /*#__PURE__*/React.createElement("div", {
    style: {
      flex: 1,
      height: 80,
      position: 'relative',
  ...
  }, layer.waves.map((h, i) => /*#__PURE__*/React.createElement("div", {
    key: i,
    style: {
      flex: 1,
      borderRadius: 2,
      ...
      // Ensure minimum height is visible
      opacity: 1
    }
  }))), (isPlaying || isScrubbing || showScrubActions) && /*#__PURE__*/React.createElement("div", {
    style: {
  ...
  }), nudgeMode[layer.id] && /*#__PURE__*/React.createElement("div", {
    style: {
      position: 'absolute',
      bottom: 2,
      right: 4,
  ...
  }, ((layer.timeShift || 0) * 1000).toFixed(0), "ms")), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      alignItems: 'center',
      gap: 6,
  ...
  })), index === 0 && !isRecording && /*#__PURE__*/React.createElement("button", {
    ...
    name: "Trash2",
    size: 14
  })))))), layers.length > 0 && !isRecording && /*#__PURE__*/React.createElement("div", {
    style: {
      position: 'fixed',
      bottom: 80,
      left: 0,
  ...
  }, "Master Feed"), /*#__PURE__*/React.createElement("span", {
    style: {
      fontSize: 10,
      fontFamily: 'monospace',
      fontWeight: 700,
  ...
  }, formatScrubTime(progress / 100 * sessionDuration), " / ", formatScrubTime(sessionDuration))), /*#__PURE__*/React.createElement("div", {
    style: {
      height: 8,
  ...
  }, "Export Wax"))), showSaveModal && /*#__PURE__*/React.createElement("div", {
  ...
  }, "EXPORT WAX"), /*#__PURE__*/React.createElement("button", {
    onClick: () => !isSaving && setShowSaveModal(false),
    disabled: isSaving,
    style: {
      color: 'var(--white)',
  ...
  }, "Press Your Wax"), /*#__PURE__*/React.createElement("p", {
    style: {
      color: 'var(--gray)',
      marginBottom: 20,
      fontSize: 10,
  ...
  }, layers.length, " LAYER", layers.length !== 1 ? 'S' : '', " \u2022 MASTER MIX"), /*#__PURE__*/React.createElement("div", {
    style: {
      marginBottom: 20
    }
  }, /*#__PURE__*/React.createElement("label", {
  ...
  }, "SESSION TITLE"), /*#__PURE__*/React.createElement("input", {
    type: "text",
    value: sessionTitle,
    ...
    name: "Download",
    size: 14
  }), isSaving ? 'PRESSING...' : 'DOWNLOAD WAV'), /*#__PURE__*/React.createElement("button", {
    ...
    name: "Cloud",
    size: 14
  }), isSaving ? 'SAVING...' : 'SAVE TO CLOUD'), /*#__PURE__*/React.createElement("button", {
  ...
  }, "NEVERMIND")))), showLoadModal && /*#__PURE__*/React.createElement("div", {
    className: "animate-fade-in",
    style: {
      position: 'fixed',
      inset: 0,
  ...
  }, savedSessions.length === 0 ? /*#__PURE__*/React.createElement("div", {
    style: {
      padding: 48,
      textAlign: 'center',
      display: 'flex',
  ...
  }, "NO SAVED SESSIONS YET")) : /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      flexDirection: 'column',
      gap: 8
    }
  }, savedSessions.map(session => /*#__PURE__*/React.createElement("button", {
    key: session.id,
  ...
  }, new Date(session.created_at).toLocaleDateString(), session.beat_title && ` • ${session.beat_title}`))))))), showBpmPopup && /*#__PURE__*/React.createElement("div", {
    style: {
      position: 'fixed',
      inset: 0,
      zIndex: 100,
  ...
  }, "METRONOME"), /*#__PURE__*/React.createElement("button", {
    onClick: () => setShowBpmPopup(false),
    style: {
      color: '#666',
      background: 'none',
  ...
  }, /*#__PURE__*/React.createElement("span", null, "40"), /*#__PURE__*/React.createElement("span", null, "200"))), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'grid',
  ...
  }, [60, 80, 90, 100, 110, 120, 140, 160].map(preset => /*#__PURE__*/React.createElement("button", {
    key: preset,
