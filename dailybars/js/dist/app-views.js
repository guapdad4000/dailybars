...
const FeedView = ({
  ...
  return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(QuickInput, {
    onSave: onAddBar,
    onTyping: onTyping,
  ...
  }, "LOADING...")) : bars.length > 0 ? bars.map((bar, i) => /*#__PURE__*/React.createElement(IdeaCard, {
    key: bar.id,
    bar: bar,
    index: i,
  ...
  }, "NO BARS YET")), /*#__PURE__*/React.createElement(ImagePreview, {
    src: previewImage,
...
const ArchiveView = ({
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, bars.map(bar => /*#__PURE__*/React.createElement("button", {
    key: bar.id,
  ...
  }, bar.imageUrl ? /*#__PURE__*/React.createElement("img", {
    src: bar.imageUrl,
    alt: "",
  ...
  }, bar.text), /*#__PURE__*/React.createElement("span", {
    style: {
      fontSize: 8,
      color: 'var(--gray)'
    }
  }, formatDate(bar.created_at))), bar.isFavorite && /*#__PURE__*/React.createElement("div", {
    style: {
      position: 'absolute',
      top: 6,
      right: 6,
    ...
    name: "Star",
    size: 10
  })))), bars.length === 0 && /*#__PURE__*/React.createElement("div", {
    style: {
      gridColumn: '1 / -1',
      padding: 80,
      textAlign: 'center',
...
const CratesView = ({
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, "START NEW SONG")), /*#__PURE__*/React.createElement("button", {
    ...
    d: "M498 18L502 22M502 18L498 22",
    stroke: "#374151",
    strokeWidth: "1"
  }), /*#__PURE__*/React.createElement("circle", {
    cx: "20",
    ...
    d: "M18 378L22 382M22 378L18 382",
    stroke: "#374151",
    strokeWidth: "1"
  }), /*#__PURE__*/React.createElement("circle", {
    cx: "500",
    ...
    d: "M498 378L502 382M502 378L498 382",
    stroke: "#374151",
    strokeWidth: "1"
    ...
    letterSpacing: "2"
  }, "SEQUENCE CALENDAR")), /*#__PURE__*/React.createElement("div", {
    style: {
      position: 'absolute',
      top: '22%',
      // 88 / 400
  ...
  }, calendarLabel), /*#__PURE__*/React.createElement("button", {
    onClick: () => setCalendarMonth(new Date(calendarYear, calendarMonthIndex + 1, 1)),
    style: {
      padding: '2% 5%',
      borderRadius: 4,
  ...
  }, ['S', 'M', 'T', 'W', 'T', 'F', 'S'].map(day => /*#__PURE__*/React.createElement("div", {
    key: day,
    className: "font-mono",
    style: {
      fontSize: 'clamp(8px, 2vw, 10px)',
    ...
    }, day, count > 0 && !isActive && /*#__PURE__*/React.createElement("span", {
      style: {
        position: 'absolute',
        top: '10%',
        right: '10%',
    ...
    day: 'numeric',
    year: 'numeric'
  })), activeSongs.length === 0 ? /*#__PURE__*/React.createElement("div", {
    className: "font-mono",
    style: {
      fontSize: 10,
      color: '#9CA3AF'
    }
  }, "NO SONGS LOGGED FOR THIS DAY.") : /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      flexDirection: 'column',
      gap: 8
    }
  }, activeSongs.map(song => /*#__PURE__*/React.createElement("button", {
    key: song.id,
    onClick: () => {
      onEditSong(song);
  ...
  }, /*#__PURE__*/React.createElement("span", null, song.title || 'UNTITLED SONG'), /*#__PURE__*/React.createElement("span", {
    className: "font-mono",
    style: {
      fontSize: 9,
      color: '#6B7280'
    }
  }, formatTime(song.updated_at || song.created_at)))))), /*#__PURE__*/React.createElement("button", {
  ...
  }, "CLOSE CALENDAR"))), /*#__PURE__*/React.createElement("div", {
    style: {
      width: '100%',
      display: 'flex',
      flexDirection: 'column',
  ...
  }, "NO NEWS IS GOOD NEWS"), /*#__PURE__*/React.createElement("div", {
    className: "font-mono",
    style: {
      fontSize: 10,
      marginTop: 4
    }
  }, "START A TRACK ABOVE")) : songs.map((song, i) => {
    ...
    return /*#__PURE__*/React.createElement("article", {
    ...
    }, song.title || 'THE UNTITLED'), /*#__PURE__*/React.createElement("div", {
      className: "font-mono",
      style: {
        fontSize: 8,
        color: 'var(--gray)',
    ...
    }, /*#__PURE__*/React.createElement("span", null, "VOL. ", songs.length - i), /*#__PURE__*/React.createElement("span", null, formatDate(song.updated_at)))), /*#__PURE__*/React.createElement("div", {
      style: {
        display: 'flex',
        gap: 12,
        textAlign: 'left'
    ...
    }, snippet ? "LATEST DEVELOPMENTS IN THE LAB" : "BREAKING NEWS"), /*#__PURE__*/React.createElement("div", {
      style: {
    ...
    }, snippet || "No content available for this song. Tap to write..."), /*#__PURE__*/React.createElement("div", {
      style: {
        display: 'flex',
        flexWrap: 'wrap',
        gap: 6,
      ...
      className: "crate-meta-pill"
    }, /*#__PURE__*/React.createElement(Icon, {
      name: "Building2",
      size: 12
    }), " ", song.studio || 'No studio logged'), /*#__PURE__*/React.createElement("span", {
      className: "crate-meta-pill"
    }, /*#__PURE__*/React.createElement(Icon, {
      name: "BadgeCheck",
      size: 12
    }), " ", song.producer || 'Producer TBD'), /*#__PURE__*/React.createElement("span", {
      className: "crate-meta-pill"
    }, /*#__PURE__*/React.createElement(Icon, {
      name: "Music",
      size: 12
    }), " ", song.key || 'Key open'), /*#__PURE__*/React.createElement("span", {
      className: "crate-meta-pill"
    }, /*#__PURE__*/React.createElement(Icon, {
      name: "Activity",
      size: 12
    }), " ", song.bpm ? `${song.bpm} BPM` : 'BPM free'))), hasImage && /*#__PURE__*/React.createElement("div", {
      style: {
        width: '35%',
        flexShrink: 0
      }
...
const FavoritesView = ({
  ...
  return /*#__PURE__*/React.createElement("div", null, favorites.length > 0 ? favorites.map(bar => /*#__PURE__*/React.createElement("button", {
    key: bar.id,
    onClick: () => onSelect(bar),
    style: {
      width: '100%',
  ...
  }, formatDate(bar.created_at)), /*#__PURE__*/React.createElement("p", {
    className: "font-serif",
    style: {
      fontSize: 15,
      lineHeight: 1.4,
  ...
  }, bar.text)))) : /*#__PURE__*/React.createElement("div", {
    style: {
      padding: 80,
      textAlign: 'center'
    }
...
const SyndicateViewOld = ({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    name: "Plus",
    size: 16
  }), " CONTRIBUTE TO THE VAULT") : /*#__PURE__*/React.createElement("div", {
    className: "animate-slide-up"
  ...
  }, isSubmitting ? 'UPLOADING...' : 'DROP IT')))), loading ? /*#__PURE__*/React.createElement("div", {
    style: {
      padding: 60,
      textAlign: 'center',
      fontSize: 11,
  ...
  }, "LOADING THE SYNDICATE...") : prompts.length === 0 ? /*#__PURE__*/React.createElement("div", {
    style: {
      padding: 60,
      textAlign: 'center',
      opacity: 0.5
  ...
  }, "THE VAULT IS EMPTY"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 9,
      marginTop: 4
    }
  }, "BE THE FIRST TO DROP A GEM")) : /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'grid',
      gap: 2,
      padding: 2,
  ...
  }, prompts.map((p, i) => /*#__PURE__*/React.createElement("div", {
    key: p.id || i,
    className: "animate-slide-up",
    style: {
      background: 'var(--white)',
  ...
  }, p.prompt_text), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      justifyContent: 'space-between',
      fontSize: 9,
  ...
  }, /*#__PURE__*/React.createElement("span", null, "FROM: @", p.author), /*#__PURE__*/React.createElement("span", null, "\uD83D\uDC8E ", p.likes || 0))))));
};
...
const BarDetail = ({
  ...
  }, formatDate(bar.created_at), " \u2014 ", formatTime(bar.created_at)), isEditing ? /*#__PURE__*/React.createElement("div", {
    style: {
      background: 'var(--electric)',
      padding: 12,
      margin: -8
    }
  }, /*#__PURE__*/React.createElement(RhymeTextarea, {
    value: editText,
  ...
  }, bar.text), bar.audioUrl && /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 20
    }
  }, /*#__PURE__*/React.createElement("div", {
  ...
  }, "VOICE MEMO"), window.VinylAudioPlayer ? /*#__PURE__*/React.createElement(window.VinylAudioPlayer, {
    src: bar.audioUrl
  ...
  })), bar.tags?.length > 0 && /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 24,
      display: 'flex',
      gap: 8,
  ...
  }, bar.tags.map((tag, i) => /*#__PURE__*/React.createElement("span", {
    key: i,
    style: {
      border: '1px solid var(--black)',
      padding: '4px 10px',
...
const TrackEditor = ({
  ...
  useEffect(() => {
    ...
    const setupPresence = async () => {
      presenceChannel.current = await window.DailyDepositEngine.joinSongSession(song.id, user?.id, user?.username);

      // Listen for presence changes
      presenceChannel.current.on('presence', {
        event: 'sync'
      }, () => {
  ...
  const handleRhymeSelect = rhyme => {
    setBlocks(prev => prev.map((block, idx) => {
      ...
      return {
        ...block,
        content: `${block.content || ''}${needsSpace ? ' ' : ''}${rhyme}`
      };
    }));
    setRhymePopup({
      show: false,
  ...
  const handleCoverUpload = async e => {
    ...
    if (file) {
      try {
        ...
        toast?.addToast('IMAGE FAILED', 'error');
      }
    }
  };
  ...
  const handleBeatUpload = async e => {
    ...
    try {
      ...
      const uploadPromise = window.DailyDepositEngine.uploadBeat(user?.id, file, song?.id, beatMetadata);
      const uploadTimeoutPromise = new Promise((_, reject) => setTimeout(() => reject(new Error('Upload timed out. Please try again.')), 60000));
      ...
      const isRLSError = err.message?.includes('row-level security') || err.message?.includes('StorageApiError') || err.message?.includes('policy');
      if (isRLSError) {
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, beatUrl && /*#__PURE__*/React.createElement("audio", {
    ref: beatAudioRef,
    src: beatUrl,
    loop: true,
    ...
    name: "ArrowLeft",
    size: 20
  })), activeUsers.length > 1 && /*#__PURE__*/React.createElement("div", {
    style: {
      position: 'fixed',
      top: 'calc(env(safe-area-inset-top) + 16px)',
      left: '50%',
  ...
  }), activeUsers.length, " WRITERS LIVE"), /*#__PURE__*/React.createElement("button", {
  ...
  }, saving ? 'SAVING...' : 'SAVE'), showCollabModal && /*#__PURE__*/React.createElement("div", {
    className: "animate-fade-in",
    style: {
      position: 'fixed',
      inset: 0,
  ...
  }, "LIVE NOW (", activeUsers.length, ")"), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      flexWrap: 'wrap',
      gap: 8
    }
  }, activeUsers.map((u, i) => /*#__PURE__*/React.createElement("div", {
    key: i,
    style: {
      display: 'flex',
      alignItems: 'center',
  ...
  }), "@", u.username || 'Guest')), activeUsers.length === 0 && /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 10,
      color: 'var(--gray)'
    }
  }, "Just you right now"))), /*#__PURE__*/React.createElement("div", {
    style: {
      marginBottom: 20
    }
  }, /*#__PURE__*/React.createElement("div", {
  ...
  }, "INVITE COLLABORATORS"), collabLink ? /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      gap: 8
    }
  ...
  }, "Link expires in 7 days. Anyone with link can edit.")), collaborators.length > 0 && /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 10,
      fontWeight: 700,
      letterSpacing: '0.1em',
  ...
  }, "COLLABORATORS (", collaborators.length, ")"), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      flexDirection: 'column',
      gap: 6
    }
  }, collaborators.map((c, i) => /*#__PURE__*/React.createElement("div", {
    key: i,
    style: {
      display: 'flex',
      justifyContent: 'space-between',
  ...
  }, "@", c.username || 'Anonymous'), /*#__PURE__*/React.createElement("span", {
    style: {
      fontSize: 9,
      color: 'var(--gray)',
      textTransform: 'uppercase'
    }
  }, c.role)))))))), showBeatLocker && /*#__PURE__*/React.createElement("div", {
    className: "animate-fade-in",
    style: {
      position: 'fixed',
      inset: 0,
  ...
  }, "BEAT LOCKER")), /*#__PURE__*/React.createElement("button", {
    onClick: () => setShowBeatLocker(false)
  }, /*#__PURE__*/React.createElement(Icon, {
    name: "X",
    size: 20,
    color: "white"
  ...
  }, "UPLOAD MP3 FILE"), /*#__PURE__*/React.createElement("span", {
    style: {
      fontSize: 9,
      color: 'var(--gray)'
    }
  }, "Local file, loops forever"), /*#__PURE__*/React.createElement("input", {
    type: "file",
    accept: "audio/*,.mp3,.m4a,.wav,.aac,.ogg,.webm,.flac,.aiff,audio/mpeg,audio/mp4,audio/x-m4a,audio/wav,audio/aac,audio/ogg,audio/webm,audio/flac",
  ...
  }, "ADD YOUTUBE VIDEO"), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      gap: 8
    }
  ...
  }, "ADD"))))), /*#__PURE__*/React.createElement("header", {
    style: {
      borderBottom: '2px solid var(--black)',
      backgroundImage: 'url(images/smooth-paper-texture.jpg)',
      backgroundSize: 'cover',
      backgroundPosition: 'center',
      paddingTop: 'max(60px, calc(env(safe-area-inset-top) + 50px))'
    }
  }, /*#__PURE__*/React.createElement("div", {
    style: {
      borderTop: '2px solid var(--black)',
    ...
    style: {
      ...
      // Added top padding to prevent clipping
      position: 'relative',
    ...
    style: {
      width: '100%',
      maxWidth: videoUrl ? '100%' : '300px',
      // Constrain width when centered alone
      height: '100%',
      cursor: 'pointer',
      transition: 'all 0.3s ease',
      pointerEvents: 'auto'
    }
  }, /*#__PURE__*/React.createElement(RadioWidget, {
    isPlaying: beatPlaying
  })), beatUrl && /*#__PURE__*/React.createElement("button", {
    onClick: e => {
      e.stopPropagation();
      clearBeat();
    },
    ...
    style: {
      position: 'absolute',
      bottom: '20%',
      // ~Quarter up from bottom
      left: 0,
      right: 0,
      textAlign: 'center',
      pointerEvents: 'none',
      // Let clicks pass through to radio
      zIndex: 10
    }
  }, /*#__PURE__*/React.createElement("span", {
    style: {
  ...
  }, !beatUrl ? "OPEN BEAT LOCKER" : beatPlaying ? "NOW PLAYING" : "CLICK TO PLAY")))), videoUrl && /*#__PURE__*/React.createElement("div", {
    style: {
      width: '50%',
      display: 'flex',
      flexDirection: 'column',
  ...
  }, "FIG 1. FRONT PAGE ART")) : /*#__PURE__*/React.createElement("label", {
    style: {
      display: 'flex',
      flexDirection: 'column',
      alignItems: 'center',
  ...
  }, "ADD COVER ART"), /*#__PURE__*/React.createElement("input", {
    type: "file",
    accept: "image/*",
    ...
    style: {
      padding: 16,
      borderBottom: '1px solid var(--black)',
      background: 'linear-gradient(135deg, rgba(255,255,255,0.9), rgba(244,244,240,0.9))'
    }
  }, /*#__PURE__*/React.createElement("button", {
  ...
  }, "SESSION DETAILS"), /*#__PURE__*/React.createElement("div", {
    className: "font-mono",
    style: {
      fontSize: 10,
      color: 'var(--gray)'
    }
  }, "Dial in the credits and cadence")), /*#__PURE__*/React.createElement("div", {
    style: {
      width: 28,
      height: 28,
      border: '2px solid var(--black)',
    ...
    name: sessionDetailsOpen ? 'ChevronUp' : 'ChevronDown',
    size: 16
  }))), sessionDetailsOpen && /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'grid',
  ...
  }, "STUDIO"), /*#__PURE__*/React.createElement("input", {
    value: studio,
  ...
  }, "PRODUCER"), /*#__PURE__*/React.createElement("input", {
    value: producer,
  ...
  }, "OTHER ARTISTS"), /*#__PURE__*/React.createElement("input", {
    value: otherArtists,
  ...
  }, "BPM"), /*#__PURE__*/React.createElement("input", {
    type: "number",
    value: bpm,
  ...
  })))), blocks.map((block, i) => /*#__PURE__*/React.createElement("div", {
    key: block.id,
    style: {
      borderBottom: '1px solid var(--light-gray)',
      position: 'relative'
    ...
    name: "ArrowUp",
    size: 12
  })), i < blocks.length - 1 && /*#__PURE__*/React.createElement("button", {
    ...
    name: "X",
    size: 12
  }))), block.type === 'text' ? /*#__PURE__*/React.createElement("div", {
    style: {
      padding: 16,
      background: 'var(--white)'
    }
  }, (block.label || block.source === 'ai') && /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      gap: 8,
      alignItems: 'center',
  ...
  }, block.label && /*#__PURE__*/React.createElement("span", {
    style: {
      fontSize: 9,
      fontWeight: 800,
      letterSpacing: '0.1em'
    }
  }, block.label), block.source === 'ai' && /*#__PURE__*/React.createElement("span", {
    style: {
      fontSize: 8,
      letterSpacing: '0.1em',
      background: 'var(--electric)',
  ...
  }, "AI DRAFT")), /*#__PURE__*/React.createElement(RhymeTextarea, {
    value: block.content,
  ...
  })) : block.type === 'heading' ? /*#__PURE__*/React.createElement("input", {
    value: block.content,
    onChange: e => updateBlock(i, e.target.value),
  ...
  }) : block.type === 'image' ? /*#__PURE__*/React.createElement("div", {
    style: {
      padding: 16,
      background: 'var(--white)'
    }
  }, block.content ? /*#__PURE__*/React.createElement("div", {
    style: {
      position: 'relative'
    }
  }, /*#__PURE__*/React.createElement("img", {
  ...
  }, "CHANGE")) : /*#__PURE__*/React.createElement("label", {
    style: {
      display: 'flex',
      alignItems: 'center',
      justifyContent: 'center',
    ...
    name: "Image",
    size: 16
  }), " ADD IMAGE BLOCK", /*#__PURE__*/React.createElement("input", {
    type: "file",
    accept: "image/*",
    onChange: e => handleBlockImageUpload(i, e),
    style: {
      display: 'none'
    }
  }))) : block.type === 'audio' ? /*#__PURE__*/React.createElement("div", {
    style: {
      padding: 16,
      background: 'var(--white)'
    }
  ...
  }, window.VinylAudioPlayer ? /*#__PURE__*/React.createElement(window.VinylAudioPlayer, {
    src: block.content,
    compact: true
  }) : /*#__PURE__*/React.createElement("audio", {
    src: block.content,
    ...
    name: "RefreshCw",
    size: 12
  }), " REPLACE CLIP", /*#__PURE__*/React.createElement("input", {
    type: "file",
    accept: "audio/*",
    onChange: e => handleBlockAudioUpload(i, e),
    style: {
      display: 'none'
    }
  })), /*#__PURE__*/React.createElement("button", {
    ...
    name: "Mic",
    size: 12
  }), " RECORD NEW"))) : /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      flexDirection: 'column',
      gap: 10
    ...
    name: "Mic",
    size: 16
  }), " RECORD VOICE NOTE"), /*#__PURE__*/React.createElement("label", {
    style: {
      display: 'flex',
      alignItems: 'center',
      justifyContent: 'center',
    ...
    name: "Upload",
    size: 14
  }), " UPLOAD AUDIO", /*#__PURE__*/React.createElement("input", {
    type: "file",
    accept: "audio/*",
    onChange: e => handleBlockAudioUpload(i, e),
    style: {
  ...
  }))), recordingBlockIndex === i && (isRecording || audioUrl || recordError) && /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 12,
      padding: 12,
      border: '1px solid var(--black)',
  ...
  }, Math.floor(duration / 60), ":", (duration % 60).toString().padStart(2, '0')), /*#__PURE__*/React.createElement("button", {
    onClick: handleStopBlockRecording,
    style: {
      padding: '6px 10px',
      border: '2px solid #EF4444',
      background: 'transparent',
  ...
  }, audioUrl && (window.VinylAudioPlayer ? /*#__PURE__*/React.createElement(window.VinylAudioPlayer, {
    src: audioUrl,
    compact: true
  }) : /*#__PURE__*/React.createElement("audio", {
    src: audioUrl,
    ...
    onClick: () => handleSaveBlockRecording(i),
    style: {
      flex: 1,
      padding: '8px 10px',
      background: 'var(--brand-green)',
    ...
    onClick: handleDiscardBlockRecording,
    style: {
      flex: 1,
      padding: '8px 10px',
      border: '2px solid var(--black)',
  ...
  }, "DISCARD"))), recordError && /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 8,
      fontSize: 10,
      color: '#EF4444',
  ...
  }, recordError, " - ENABLE MICROPHONE ACCESS"))) : /*#__PURE__*/React.createElement("div", {
    style: {
      padding: '24px 16px',
  ...
  }, "\u2014 BREAK \u2014"))), blocks.length === 0 && !coverImage && /*#__PURE__*/React.createElement("div", {
    style: {
      padding: 60,
      textAlign: 'center'
    }
  ...
  }, "ADD BLOCKS TO START"))), /*#__PURE__*/React.createElement("div", {
    style: {
      position: 'sticky',
      bottom: 0,
      left: 0,
  ...
  }, "YOUR INPUT"), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      gap: 8,
      overflowX: 'auto'
    }
  }, userBlockOptions.map(item => /*#__PURE__*/React.createElement("button", {
    key: item.label,
  ...
  }, "AI ASSIST"), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex'
    }
  }, [{
  ...
  }, aiLoading ? '...' : item.label))))), rhymePopup.show && /*#__PURE__*/React.createElement(RhymePopup, {
...
}, password.length > 0 ? passwordStrength.strength.toUpperCase() : ''), passwordStrength.feedback.length > 0 && password.length > 0 && /*#__PURE__*/React.createElement("span", {
  style: {
    color: 'var(--gray)'
  }
...
const LoginInputField = ({
  ...
  autoComplete: label === 'PASSWORD' ? 'current-password' : label === 'CREATE PASSWORD' ? 'new-password' : label === 'CONFIRM PASSWORD' ? 'new-password' : label === 'EMAIL ADDRESS' ? 'email' : label === 'EMAIL OR USERNAME' ? 'username' : label === 'ARTIST NAME' ? 'username' : 'off',
  value: value,
  onChange: onChange,
...
const isDevelopmentPreview = () => {
  ...
  return hostname === 'localhost' || hostname === '127.0.0.1' || hostname.endsWith('.replit.dev') || hostname.endsWith('.repl.co');
};
const LoginScreen = ({
  onLogin
}) => {
  ...
  const handleSubmit = async e => {
    ...
    try {
      ...
      const isAdminLogin = !isSignUp && (loginInput === 'guap@dailybars.com' || loginInput === 'guap' || loginInput === 'guapdad@gmail.com') && password === 'admin123';
      if (isAdminLogin) {
        // Look for existing guap user or guapdad@gmail.com user
        const adminUser = users.find(u => u.username?.toLowerCase() === 'guap' || u.email?.toLowerCase() === 'guapdad@gmail.com');
        ...
        onLogin({
          id: guapUser.id,
          username: guapUser.username || 'guap',
          email: guapUser.email || 'guapdad@gmail.com',
          xp: guapUser.xp || 0,
          level: guapUser.level || 1
        });
        return;
      }

      // Find user by email OR username for login
      const existingUser = isSignUp ? users.find(u => u.email?.toLowerCase() === email.toLowerCase()) : users.find(u => u.email?.toLowerCase() === loginInput || u.username?.toLowerCase() === loginInput);
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: `animate-slide-up ${error ? 'animate-rumble' : ''}`,
    style: {
      width: '100%',
      maxWidth: 360,
      textAlign: 'center',
  ...
  }, "CREATE ACCOUNT")), isSignUp && /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      justifyContent: 'center',
      gap: 8,
  ...
  }, !isSignUp && /*#__PURE__*/React.createElement(LoginInputField, {
  ...
  }), isSignUp && step === 1 && /*#__PURE__*/React.createElement(LoginInputField, {
    label: "EMAIL ADDRESS",
    type: "email",
    value: email,
  ...
  }), isSignUp && step === 2 && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("button", {
    type: "button",
    onClick: () => setStep(1),
    style: {
      display: 'flex',
    ...
    name: "ArrowLeft",
    size: 14
  }), "BACK TO EMAIL"), /*#__PURE__*/React.createElement("div", {
    style: {
  ...
  }, /*#__PURE__*/React.createElement("strong", null, "EMAIL:"), " ", email), /*#__PURE__*/React.createElement(LoginInputField, {
    label: "ARTIST NAME",
    type: "text",
    value: username,
  ...
  }), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(LoginInputField, {
  ...
  })), /*#__PURE__*/React.createElement(LoginInputField, {
  ...
  }, agreedToTerms && /*#__PURE__*/React.createElement(Icon, {
    name: "Check",
    size: 14,
    color: "white"
  })), /*#__PURE__*/React.createElement("span", {
  ...
  }, "Privacy Policy")))), !isSignUp && /*#__PURE__*/React.createElement("label", {
    style: {
      display: 'flex',
      alignItems: 'center',
      gap: 12,
  ...
  }, rememberMe && /*#__PURE__*/React.createElement(Icon, {
    name: "Check",
    size: 12,
    color: "white"
  })), /*#__PURE__*/React.createElement("span", {
  ...
  }, "REMEMBER ME")), error && /*#__PURE__*/React.createElement("div", {
    className: "animate-pulse",
    style: {
      color: '#EF4444',
      fontSize: 11,
  ...
  }, "\u27F3"), "PROCESSING...") : isSignUp ? step === 1 ? 'CONTINUE →' : 'CREATE ACCOUNT' : 'ENTER THE LAB')), !isSignUp && /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 20
    }
  }, /*#__PURE__*/React.createElement("button", {
  ...
  }, "FORGOT PASSWORD?")), !isSignUp && isDevelopmentPreview() && /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 18,
      paddingTop: 18,
  ...
  }, "ENTER DEV QA ACCOUNT"), /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 8,
      color: 'var(--gray)',
      fontSize: 9,
  ...
  }, "LOCAL PREVIEW ONLY \xB7 NO PASSWORD REQUIRED")), /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 40,
      fontSize: 9,
      color: 'var(--gray)',
  ...
  }, "RESTRICTED ACCESS // OAKLAND CA"), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      justifyContent: 'center',
      gap: 16,
    ...
    size: 12,
    color: "var(--gray)"
  }), " SECURE"), /*#__PURE__*/React.createElement("span", null, "\u2022"), /*#__PURE__*/React.createElement("span", {
    style: {
      display: 'flex',
      alignItems: 'center',
      gap: 4
    ...
    size: 12,
    color: "var(--gray)"
  }), " MOBILE-FIRST"), /*#__PURE__*/React.createElement("span", null, "\u2022"), /*#__PURE__*/React.createElement("span", {
    style: {
      display: 'flex',
      alignItems: 'center',
      gap: 4
...
const TrophyCaseView = ({
  ...
  const processTrophies = (trophies, unlocks) => {
    ...
    const formattedItems = trophies.map(t => ({
      ...
      scale: 0.8 + parseInt(t.id.slice(-2), 16) % 4 * 0.1,
      // Deterministic scale based on ID
    ...
    return chunks.map((tileItems, tileIndex) => {
      ...
      const rows = [tileItems.slice(0, 3), tileItems.slice(3, 6), tileItems.slice(6, 9)];
  ...
  const ShelfItem = ({
    ...
    return /*#__PURE__*/React.createElement("div", {
    ...
    }, isShowcased && item.unlocked && /*#__PURE__*/React.createElement("div", {
      style: {
        position: 'absolute',
        inset: -8,
    ...
    }), item.unlocked && /*#__PURE__*/React.createElement("div", {
      style: {
        position: 'absolute',
        inset: -10,
      ...
      style: {
        position: 'relative',
        zIndex: 10,
        filter: item.unlocked ? 'drop-shadow(0 6px 10px rgba(0,0,0,0.5))' : 'drop-shadow(0 4px 6px rgba(0,0,0,0.3)) brightness(0.7)',
        color: item.color
      }
      ...
      alt: item.name,
      style: {
        width: item.unlocked ? 90 : 80,
        // DOUBLED from 56/40
        height: item.unlocked ? 90 : 80,
        objectFit: 'contain',
        borderRadius: 6,
        opacity: item.unlocked ? 1 : 0.75,
        // Brighter when locked (was too dim)
    ...
    }, item.xp_cost, " XP")), /*#__PURE__*/React.createElement("div", {
      style: {
        height: 10,
        width: '80%',
    ...
    }, item.name), item.description && /*#__PURE__*/React.createElement("div", {
      style: {
        fontSize: 8,
        color: '#aaa',
        marginTop: 2
  ...
  const Shelf = ({
    ...
    }, items.map((item, i) => /*#__PURE__*/React.createElement(ShelfItem, {
      key: item?.id || i,
      item: item
    })));
  };
  const CabinetTile = ({
    ...
    }, CABINET_CONFIG.rows.map((rowConfig, idx) => /*#__PURE__*/React.createElement(Shelf, {
      key: rowConfig.id,
      config: rowConfig,
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, tiles.length * 3, " SHELVES LOADED"))), /*#__PURE__*/React.createElement("button", {
    onClick: onClose,
    style: {
      color: 'white',
      padding: 8
  ...
  }, tiles.map(tile => /*#__PURE__*/React.createElement(CabinetTile, {
    key: tile.id,
    rowData: tile.data
  }))), loading && /*#__PURE__*/React.createElement("div", {
    style: {
  ...
  }, "POLISHING TROPHIES...")))), /*#__PURE__*/React.createElement("button", {
    onClick: () => document.querySelector('.scrollable').scrollTo({
      top: 0,
      behavior: 'smooth'
    }),
    style: {
    ...
    size: 24,
    color: "black"
  })), confirmUnlock && /*#__PURE__*/React.createElement("div", {
    style: {
      position: 'fixed',
      inset: 0,
      zIndex: 9999,
  ...
  }, "UNLOCK TROPHY"), /*#__PURE__*/React.createElement("button", {
    onClick: () => setConfirmUnlock(null),
    style: {
      background: 'none',
      border: 'none',
  ...
  }, confirmUnlock.name), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 12,
      color: 'var(--gray)',
      marginBottom: 16
    }
  }, "Spend ", confirmUnlock.xp_cost, " XP to unlock this trophy?"), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      justifyContent: 'space-between',
      padding: '12px 16px',
  ...
  }, /*#__PURE__*/React.createElement("span", null, "YOUR XP: ", user.xp || 0), /*#__PURE__*/React.createElement("span", null, "AFTER: ", (user.xp || 0) - confirmUnlock.xp_cost))), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      gap: 12,
  ...
  }, "UNLOCK")))), /*#__PURE__*/React.createElement("style", null, `
...
const SafeComponent = () => {
  ...
  }, LAYER_ORDER.map(layerName => /*#__PURE__*/React.createElement("div", {
    key: layerName,
...
const SyndicateView = ({
  ...
  const toast = useToast();
  const courseStorageKey = useMemo(() => user?.username ? `syndicate_courses_${user.username}` : 'syndicate_courses_guest', [user?.username]);
  ...
  const handleOpenCourse = course => {
    try {
      const blob = new Blob([course.html], {
        type: 'text/html'
      });
  ...
  const renderCoursePreview = course => /*#__PURE__*/React.createElement("div", {
    style: {
      background: 'var(--white)',
      border: '1px solid var(--black)',
      padding: 10,
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, "THE VAULT"), /*#__PURE__*/React.createElement("button", {
  ...
  }, "FREE GAME"), /*#__PURE__*/React.createElement("button", {
    ...
    name: "Award",
    size: 16
  }))), tab === 'vault' && /*#__PURE__*/React.createElement("div", {
    className: "animate-slide-in",
    style: {
      position: 'relative',
      minHeight: '80vh'
    }
  }, /*#__PURE__*/React.createElement(SafeComponent, null), /*#__PURE__*/React.createElement("div", {
    style: {
      padding: '20px 20px 0',
      position: 'relative',
      zIndex: 1
  ...
  }, "COMMUNITY DROPS"), loading ? /*#__PURE__*/React.createElement("div", {
    style: {
      textAlign: 'center',
      padding: 20,
      background: 'rgba(255,255,255,0.8)',
  ...
  }, "LOADING VAULT...")) : feed.length === 0 ? /*#__PURE__*/React.createElement("div", {
    style: {
      textAlign: 'center',
      padding: 20,
      background: 'rgba(255,255,255,0.8)',
  ...
  }, "VAULT IS EMPTY")) : /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'grid',
      gap: 8,
      maxHeight: 400,
    ...
    }, "@", p.author), /*#__PURE__*/React.createElement("button", {
      onClick: async () => {
        if (hasVoted) {
    ...
    }, hasVoted ? '💎' : '◇'), /*#__PURE__*/React.createElement("span", null, p.likes || 0))));
  }))), /*#__PURE__*/React.createElement("div", {
    style: {
      padding: 20,
      position: 'relative',
  ...
  }, "SUBMIT A PROMPT"), /*#__PURE__*/React.createElement("textarea", {
    value: promptText,
    onChange: e => {
  ...
  }, submitting ? 'SENDING...' : 'SEND TO SYNDICATE')))), tab === 'free_game' && /*#__PURE__*/React.createElement("div", {
    className: "animate-slide-in",
    style: {
      position: 'relative',
      minHeight: '80vh'
  ...
  }, "PUBLIC DOMAIN BARS \u2022 FREE TO USE"), loading ? /*#__PURE__*/React.createElement("div", {
    style: {
      padding: 40,
      textAlign: 'center',
      color: 'var(--white)',
  ...
  }, "LOADING FEED...") : feed.length === 0 ? /*#__PURE__*/React.createElement("div", {
    style: {
      padding: 40,
      textAlign: 'center',
      color: 'var(--white)',
  ...
  }, "NO FREE GAME YET") : /*#__PURE__*/React.createElement("div", {
    style: {
      padding: 20,
      position: 'relative',
      zIndex: 1
    }
  }, feed.map(post => /*#__PURE__*/React.createElement("div", {
    key: post.id,
    style: {
      padding: 20,
      marginBottom: 12,
  ...
  }, /*#__PURE__*/React.createElement("span", null, "@", post.author || 'ANONYMOUS'), /*#__PURE__*/React.createElement("span", null, new Date(post.created_at).toLocaleDateString())), /*#__PURE__*/React.createElement("div", {
    className: "font-mono",
    style: {
      fontSize: 12,
      lineHeight: 1.5,
  ...
  }, post.prompt_text), /*#__PURE__*/React.createElement("button", {
    onClick: () => {
    ...
    name: "Copy",
    size: 10
  }), " STEAL THIS"))))), tab === 'courses' && /*#__PURE__*/React.createElement("div", {
    className: "animate-slide-in",
    style: {
      position: 'relative',
      minHeight: '80vh'
  ...
  }, "COURSES ARE CURATED & PAYWALLED \u2022 DAILY BARS HOSTS THE HTML SO THEY WORK IN-APP & ON WEB"), /*#__PURE__*/React.createElement("div", {
    style: {
      padding: 20,
      position: 'relative',
      zIndex: 1
  ...
  }, "COURSES COMING SOON"), /*#__PURE__*/React.createElement("span", {
    style: {
      fontSize: 10,
      color: 'var(--gray)',
      letterSpacing: '0.08em'
    }
  }, "Uploaded by Daily Bars only")), /*#__PURE__*/React.createElement("p", {
    style: {
      fontSize: 12,
      lineHeight: 1.6,
      marginBottom: 12
    }
  }, "We are building full web-page courses powered by pure HTML so they feel the same in the app or in a browser. Uploading is creator-only, and access will be handled through RevenueCat when the paywall launches."), /*#__PURE__*/React.createElement("p", {
    style: {
      fontSize: 11,
      lineHeight: 1.5,
      color: 'var(--gray)'
    }
  }, "When courses drop, you'll unlock them here after purchasing. No user uploads are allowed in this section."), /*#__PURE__*/React.createElement("button", {
    onClick: onOpenStore,
    style: {
      width: '100%',
      marginTop: 12,
  ...
  }, "VIEW ACCESS OPTIONS")), /*#__PURE__*/React.createElement("div", {
    style: {
      background: 'rgba(255,255,255,0.95)',
      border: '2px solid var(--black)',
      boxShadow: '8px 8px 0 rgba(0,0,0,0.15)',
  ...
  }, "YOUR COURSES"), /*#__PURE__*/React.createElement("p", {
    style: {
      fontSize: 11,
      lineHeight: 1.6
    }
...
const CassetteButton = ({
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("style", null, `
    ...
    id: "tape-mess",
    d: "M190 25 C 150 -50, 300 -80, 225 -150 C 150 -220, 100 -100, 50 -180 C 200 -300, 400 -200, 380 -350",
    fill: "none",
    stroke: "#3d2b1f",
    strokeWidth: "8",
    strokeLinecap: "round",
    ...
    d: "M70 240 L380 240 L360 275 L90 275 Z",
    fill: "#222",
    stroke: "#111"
  }), /*#__PURE__*/React.createElement("circle", {
    cx: "120",
    ...
    fontWeight: "bold",
    fill: "#222"
  }, user?.username ? user.username.toUpperCase() : 'USER'), /*#__PURE__*/React.createElement("text", {
    x: "70",
    y: "95",
    fontFamily: "Arial",
    fontSize: "12",
    fontWeight: "bold",
    fill: "#666"
  }, "SIDE A"), /*#__PURE__*/React.createElement("rect", {
    x: "110",
    y: "125",
    width: "230",
    height: "70",
...
const App = () => {
  ...
  const syncRevenueCatToSupabase = useCallback(async info => {
    ...
    try {
      ...
      const {
        error
      } = await supabase.from('revenuecat_customers').upsert(payload, {
        onConflict: 'user_key'
      });
      if (error) {
  ...
  const addExperience = async (amount, reason) => {
    ...
    try {
      ...
      try {
        await supabase.rpc('check_xp_trophies', {
          p_user_id: user.id,
          p_xp: newXp
        });
      } catch (trophyErr) {
  ...
  const syncPremiumUsageToSupabase = useCallback(async usageCount => {
    ...
    try {
      ...
      const {
        error
      } = await supabase.from('premium_usage').upsert(payload, {
        onConflict: 'user_key'
      });
      if (error) {
  ...
  const premiumOverlay = showPremiumPrompt ? /*#__PURE__*/React.createElement("div", {
    style: {
      position: 'fixed',
      inset: 0,
      background: 'rgba(0,0,0,0.85)',
  ...
  }, "PREMIUM REQUIRED"), /*#__PURE__*/React.createElement("button", {
  ...
  }, premiumMessage || 'Unlock premium to remove limits.'), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 11,
      color: 'var(--gray)',
      marginBottom: 12
    }
  }, "Unlimited AI runs, more than 3 crates, and persistent beat uploads come with premium access."), revenueCatError ? /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 11,
      padding: 10,
      marginBottom: 8,
  ...
  }, revenueCatError) : null, /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      flexDirection: 'column',
      gap: 8,
  ...
  }, "UPGRADE WITH REVENUECAT"), /*#__PURE__*/React.createElement("button", {
    onClick: restoreRevenueCatPurchases,
    style: {
      width: '100%',
      padding: 10,
      background: 'var(--white)',
  ...
  }, "RESTORE PURCHASES"), window.RevenueCat?.presentCustomerCenter ? /*#__PURE__*/React.createElement("button", {
    onClick: openRevenueCatCustomerCenter,
    style: {
      width: '100%',
      padding: 10,
      background: 'var(--white)',
  ...
  }, "OPEN CUSTOMER CENTER") : null), /*#__PURE__*/React.createElement("button", {
    onClick: () => setShowPremiumPrompt(false),
    style: {
      width: '100%',
      padding: 10,
  ...
  const loadUserData = async (targetUser = user) => {
    ...
    try {
      ...
      const userBars = allBars.filter(b => b.username?.toLowerCase() === username);
    ...
    try {
      ...
      const userSongs = allSongs.filter(s => s.username?.toLowerCase() === username);
    ...
    const migrateData = async () => {
      ...
      if (user?.username?.toLowerCase() === 'guap') {
        try {
          ...
          // Get all bars
          const allBars = await api.get('bars', {
            limit: 1000
          });
          const barsToMigrate = allBars.data?.filter(b => !b.username ||
          // orphan bars
          b.username === TARGET_USER_ID ||
          // bars with user ID as username
          b.user_id === TARGET_USER_ID ||
          // bars with user_id field
          ...
          const songsToMigrate = allSongs.data?.filter(s => !s.username ||
          // orphan songs
          s.username === TARGET_USER_ID ||
          // songs with user ID as username
          s.user_id === TARGET_USER_ID ||
          // songs with user_id field
    ...
    try {
      ...
      if (user?.username) {
        try {
          ...
          const {
            data: userData
          } = await supabase.from('users').select('*').eq('username', user.username).single();
          if (userData) {
            setUser(prev => ({
              ...prev,
              ...userData
  ...
  const toggleFavorite = async (id, isFavorite) => {
    try {
      await api.patch('bars', id, {
        isFavorite
      });
      setBars(prev => prev.map(b => b.id === id ? {
        ...b,
        isFavorite
      } : b));
    } catch (err) {
  ...
  if (isCheckingAuth) return /*#__PURE__*/React.createElement("div", {
    style: {
      background: 'var(--paper)',
      minHeight: '100vh'
    }
  ...
  if (!user) {
    return /*#__PURE__*/React.createElement(ToastProvider, null, /*#__PURE__*/React.createElement(LoginScreen, {
      onLogin: handleLogin
    }));
  }
  if (selectedBar) {
    return /*#__PURE__*/React.createElement(ToastProvider, null, /*#__PURE__*/React.createElement(BarDetail, {
      bar: selectedBar,
  ...
  if (editingSong) {
    return /*#__PURE__*/React.createElement(ToastProvider, null, /*#__PURE__*/React.createElement(TrackEditor, {
      song: editingSong,
  ...
  return /*#__PURE__*/React.createElement(ToastProvider, null, /*#__PURE__*/React.createElement("div", _extends({
    style: {
      minHeight: '100vh',
      paddingBottom: 40,
      display: 'flex',
  ...
  }, "OFFLINE \u2014 SAVED CHANGES WILL SYNC WHEN YOU RECONNECT"), /*#__PURE__*/React.createElement(Header, {
    ...
    className: "scrollable view-enter",
    style: {
      flex: 1
    },
    key: view
  }, view === 'feed' && /*#__PURE__*/React.createElement(FeedView, {
    bars: bars,
    onAddBar: addBar,
  ...
  }), view === 'syndicate' && /*#__PURE__*/React.createElement(SyndicateView, {
    user: user,
    onTyping: handleTyping,
  ...
  }), view === 'favorites' && /*#__PURE__*/React.createElement(FavoritesView, {
    bars: bars,
    onSelect: setSelectedBar
  }), view === 'crates' && /*#__PURE__*/React.createElement(CratesView, {
    songs: songs,
    onCreateSong: () => createSong(),
    onEditSong: setEditingSong
  }), view === 'scratchlab' && ScratchLabViewComponent && (hasPremium || user?.username?.toLowerCase() === 'guap' ? /*#__PURE__*/React.createElement(ScratchLabViewComponent, {
    user: user,
    isPremium: hasPremium,
  ...
  }, "SCRATCH LAB"), /*#__PURE__*/React.createElement("p", {
    style: {
      fontSize: 11,
      color: 'var(--gray)',
      letterSpacing: '0.1em',
  ...
  }, "Premium vocal studio for layering tracks and recording over beats. VIP/Pro access only."), /*#__PURE__*/React.createElement("button", {
  ...
  }, "Unlock Premium")))), showXPStore && /*#__PURE__*/React.createElement(TrophyCaseView, {
    user: user,
  ...
  }), crateModalBar && /*#__PURE__*/React.createElement(AddToCrateModal, {
    bar: crateModalBar,
    songs: songs,
  ...
  }), premiumOverlay, /*#__PURE__*/React.createElement(BottomBar, {
    currentView: view,
    streak: streak,
    user: user
  }), /*#__PURE__*/React.createElement(CassetteButton, {
    user: user,
  ...
  }), showProfileModal && profileModalUser && /*#__PURE__*/React.createElement(UserProfileModal, {
  ...
  }), levelUpModal && /*#__PURE__*/React.createElement("div", {
    style: {
      position: 'fixed',
      inset: 0,
      zIndex: 9999,
  ...
  }, "NEW LEVEL ACHIEVED")), /*#__PURE__*/React.createElement("div", {
    style: {
      padding: '0 20px 20px'
    }
  }, /*#__PURE__*/React.createElement("button", {
