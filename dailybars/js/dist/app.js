...
const toSnakeCase = obj => {
  ...
  for (const [key, value] of Object.entries(obj)) {
    ...
    // Special mappings
    if (key === 'imageUrl') mapped['image_url'] = value;else if (key === 'audioUrl') mapped['audio_url'] = value;else if (key === 'isFavorite') mapped['is_favorite'] = value;else if (key === 'aiGenerated') mapped['ai_generated'] = value;else if (key === 'coverImage') mapped['cover_image'] = value;else if (key === 'beatUrl') mapped['beat_url'] = value;else if (key === 'isVerified') mapped['is_verified'] = value;else if (key === 'lastLogin' || key === 'last_login') mapped['last_login'] = value;else if (key === 'promptText') mapped['prompt_text'] = value;else if (key === 'isVerified' || key === 'is_verified') mapped['is_verified'] = value;else mapped[snakeKey] = value;
  }
  return mapped;
};
const toCamelCase = obj => {
  ...
  for (const [key, value] of Object.entries(obj)) {
    // Special mappings
    if (key === 'image_url') mapped['imageUrl'] = value;else if (key === 'audio_url') mapped['audioUrl'] = value;else if (key === 'is_favorite') mapped['isFavorite'] = value;else if (key === 'ai_generated') mapped['aiGenerated'] = value;else if (key === 'cover_image') mapped['coverImage'] = value;else if (key === 'beat_url') mapped['beatUrl'] = value;else if (key === 'is_verified') mapped['isVerified'] = value;else if (key === 'last_login') mapped['lastLogin'] = value;else if (key === 'prompt_text') mapped['promptText'] = value;else if (key === 'created_at') mapped['created_at'] = value;else if (key === 'updated_at') mapped['updated_at'] = value;else {
  ...
  async get(table, params = {}) {
    ...
    try {
      ...
      if (params.sort) {
        ...
        query = query.order(snakeSortField, {
          ascending
        });
      } else {
  ...
  async create(table, data) {
    ...
    try {
      ...
      const {
        data: result,
        error
      } = await supabase.from(table).insert(snakeData).select().single();
      if (error) {
  ...
  async update(table, id, data) {
    ...
    try {
      ...
      const {
        data: result,
        error
      } = await supabase.from(table).update(snakeData).eq('id', id).select().single();
      if (error) {
  ...
  try {
    const response = await fetch(`https://generativelanguage.googleapis.com/v1beta/models/gemini-2.5-flash:generateContent?key=${GEMINI_API_KEY}`, {
      ...
      body: JSON.stringify({
        contents: [{
          parts: [{
            text: `${systemPrompt || 'You are GUAPDAD 4000\'s AI assistant. Write bars with Oakland energy - witty, slick, confident. Just output the bars, no explanations.'}\n\n${prompt}`
          }]
        }],
        generationConfig: {
          temperature: 0.9,
...
const getPhoneticEnding = word => {
  ...
  // Family (ends in y, handled specially)
  // Expanded Mappings
  {
    regex: /our$/,
    val: 'or'
...
const RhymeTextarea = ({
  ...
  const handleTouchEnd = useCallback(e => {
    ...
    const distance = Math.sqrt(Math.pow(currentPos.x - lastTapPosition.current.x, 2) + Math.pow(currentPos.y - lastTapPosition.current.y, 2));
  ...
  const {
    endingToColor
  } = useMemo(() => analyzeRhymes(value || ''), [value]);
  ...
  const rhymeLegend = useMemo(() => {
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      }, wordList.join(' · '), wordsSet.size > 3 && /*#__PURE__*/React.createElement("span", null, "+", wordsSet.size - 3));
    }));
  }, [value, endingToColor]);

  // Compute text styles
  const textStyles = useMemo(() => ({
    fontFamily: className?.includes('font-serif') ? "'Playfair Display', Georgia, serif" : className?.includes('font-mono') ? "'IBM Plex Mono', monospace" : "'IBM Plex Mono', monospace",
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    style: {
      ...
      color: 'var(--black)',
      // VISIBLE TEXT - cursor will be correct
...
const RhymeHighlightedText = ({
  ...
  const {
    endingToColor
  } = useMemo(() => analyzeRhymes(text || ''), [text]);
  if (!text) return null;
...
{
  type: 'TOPIC',
  prompt: 'Spit 8 bars about LOYALTY',
  challenge: 'Use at least one metaphor'
}, {
  type: 'TOPIC',
  prompt: 'Write about a COME UP story',
  challenge: 'Reference a specific city block'
}, {
  type: 'TOPIC',
  prompt: 'Describe your DREAM CAR',
  challenge: 'Make it sound like poetry'
}, {
  type: 'TOPIC',
  prompt: 'Talk about LATE NIGHTS',
  challenge: 'Paint a picture with words'
}, {
  type: 'TOPIC',
  prompt: 'Write about FAKE FRIENDS',
  challenge: 'Keep it real, no cap'
}, {
  type: 'TOPIC',
  prompt: 'Bars about MAKING MOVES',
  challenge: 'Include a chess reference'
}, {
  type: 'TOPIC',
  prompt: 'Spit about YOUR CITY',
  challenge: 'Name drop 3 local spots'
}, {
  type: 'TOPIC',
  prompt: 'Write about GENERATIONAL WEALTH',
  challenge: 'Reference your ancestors'
}, {
  type: 'TOPIC',
  prompt: 'Talk about THE GRIND',
  challenge: 'Use 24/7 imagery'
}, {
  type: 'TOPIC',
  prompt: 'Bars about SELF-LOVE',
  challenge: 'No flexing on others'
},
// Word challenges
{
  type: 'WORD DROP',
  prompt: 'Use the word "ALGORITHM"',
  challenge: 'Make it fit naturally in 4 bars'
}, {
  type: 'WORD DROP',
  prompt: 'Use the word "METAMORPHOSIS"',
  challenge: 'Describe a personal change'
}, {
  type: 'WORD DROP',
  prompt: 'Use the word "FREQUENCY"',
  challenge: 'Connect it to vibrations'
}, {
  type: 'WORD DROP',
  prompt: 'Use the word "CURRENCY"',
  challenge: 'Not about money, flip it'
}, {
  type: 'WORD DROP',
  prompt: 'Use the word "EMPIRE"',
  challenge: 'Building something bigger'
}, {
  type: 'WORD DROP',
  prompt: 'Use the word "LEVERAGE"',
  challenge: 'Game recognize game'
}, {
  type: 'WORD DROP',
  prompt: 'Use the word "BLUEPRINT"',
  challenge: 'Reference Jay-Z subtly'
}, {
  type: 'WORD DROP',
  prompt: 'Use the word "RENAISSANCE"',
  challenge: 'Rebirth energy'
},
// Structure challenges
{
  type: 'FLOW CHECK',
  prompt: 'Write a HOOK that sticks',
  challenge: 'Make it memorable in 4 bars max'
}, {
  type: 'FLOW CHECK',
  prompt: 'Write DOUBLE TIME bars',
  challenge: 'Pack syllables per line'
}, {
  type: 'FLOW CHECK',
  prompt: 'Write a BRIDGE section',
  challenge: 'Transition between moods'
}, {
  type: 'FLOW CHECK',
  prompt: 'Write TRIPLET FLOW bars',
  challenge: 'Migos style, 8 bars'
}, {
  type: 'FLOW CHECK',
  prompt: 'Write INTERNAL RHYMES',
  challenge: 'Rhyme within each line'
},
// Mood prompts
{
  type: 'MOOD',
  prompt: 'Write something INTROSPECTIVE',
  challenge: 'Late night vibes only'
}, {
  type: 'MOOD',
  prompt: 'Write something TRIUMPHANT',
  challenge: 'Victory lap energy'
}, {
  type: 'MOOD',
  prompt: 'Write something NOSTALGIC',
  challenge: 'Reference childhood memories'
}, {
  type: 'MOOD',
  prompt: 'Write something ROMANTIC',
  challenge: 'Keep it smooth, not corny'
}, {
  type: 'MOOD',
  prompt: 'Write something AGGRESSIVE',
  challenge: 'Channel that hunger'
},
// Collaboration prompts
{
  type: 'COLLAB READY',
  prompt: 'Write a VERSE for Kendrick',
  challenge: 'Match his conscious energy'
}, {
  type: 'COLLAB READY',
  prompt: 'Write a VERSE for Drake',
  challenge: 'Melodic and catchy'
}, {
  type: 'COLLAB READY',
  prompt: 'Write a VERSE for J. Cole',
  challenge: 'Storytelling mode'
}, {
  type: 'COLLAB READY',
  prompt: 'Write a VERSE for Tyler',
  challenge: 'Get weird with it'
},
// Bay Area specific
{
  type: 'BAY AREA',
  prompt: 'Write about THE TOWN',
  challenge: 'Oakland specific references'
}, {
  type: 'BAY AREA',
  prompt: 'Write about THE FOG',
  challenge: 'San Francisco metaphor'
}, {
  type: 'BAY AREA',
  prompt: 'Write about HYPHY',
  challenge: 'Ghost ride the whip energy'
}, {
  type: 'BAY AREA',
  prompt: 'Write about TECH MONEY',
  challenge: 'Silicon Valley observation'
}];
    ...
    try {
      ...
      mediaRecorder.current.onstop = () => {
        const blob = new Blob(chunks.current, {
          type: mediaRecorder.current?.mimeType || mimeType || 'audio/webm'
        });
        setAudioBlob(blob);
...
const useSwipe = (onSwipeLeft, onSwipeRight, threshold = 80) => {
  ...
  const onTouchMove = e => {
    ...
    if (dx > dy && dx > 20) swiping.current = true;else if (dy > dx && dy > 20) swiping.current = false;
  };
  const onTouchEnd = () => {
...
const DailyDropWidget = ({
  ...
  const DiceIcon = () => /*#__PURE__*/React.createElement("svg", {
    width: "32",
    height: "20",
    viewBox: "0 0 32 20",
    fill: "none",
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("button", {
  ...
  }, /*#__PURE__*/React.createElement(DiceIcon, null), !hasUsedToday && /*#__PURE__*/React.createElement("div", {
    style: {
      position: 'absolute',
      top: 0,
      right: 0,
  ...
  })), isOpen && ReactDOM.createPortal(/*#__PURE__*/React.createElement("div", {
    className: "daily-drop-modal animate-fade-in",
    onClick: handleClose,
    style: {
      zIndex: 9999
    } // Ensure it's above everything including the Safe background
  }, /*#__PURE__*/React.createElement("div", {
    className: "daily-drop-card animate-scale-in",
    onClick: e => e.stopPropagation()
  }, /*#__PURE__*/React.createElement("div", {
    className: "daily-drop-header"
  }, /*#__PURE__*/React.createElement("div", {
    className: "daily-drop-header-title"
  }, /*#__PURE__*/React.createElement(DiceIcon, null), /*#__PURE__*/React.createElement("span", null, "THE DAILY DROP")), /*#__PURE__*/React.createElement("button", {
    onClick: handleClose,
    style: {
      color: 'var(--white)',
      padding: 4
    ...
    className: "daily-drop-content"
  }, loading || !currentPrompt ? /*#__PURE__*/React.createElement("div", {
    style: {
      padding: 40,
      textAlign: 'center'
    }
  ...
  }, "MIXING INGREDIENTS...")) : /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
    className: "daily-drop-prompt-type"
  }, currentPrompt.type), /*#__PURE__*/React.createElement("div", {
    className: "daily-drop-prompt-text font-serif"
  }, currentPrompt.prompt), /*#__PURE__*/React.createElement("div", {
    className: "daily-drop-challenge"
  }, currentPrompt.challenge), currentPrompt.vocab && currentPrompt.vocab.length > 0 && /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 16,
  ...
  }, "REQUIRED VOCAB"), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      gap: 6,
      flexWrap: 'wrap'
    }
  }, currentPrompt.vocab.map((word, i) => /*#__PURE__*/React.createElement("span", {
    key: i,
    style: {
  ...
  }), "USE THIS")), streakCount > 0 && /*#__PURE__*/React.createElement("div", {
    className: "daily-drop-streak"
  }, /*#__PURE__*/React.createElement(SvgIcon, {
    name: "fire",
    size: 14,
    color: "var(--black)"
  }), /*#__PURE__*/React.createElement("span", null, streakCount, " DAY PROMPT STREAK")))), document.body));
};
...
const BottomBar = ({
    ...
    try {
      ...
      const restoreTable = async (tableName, rows) => {
        ...
        for (const row of rows) {
          ...
          try {
            await api.create(tableName, cleanRow);
          } catch (e) {
            console.log(`Skip ${tableName} row:`, row.id || '?');
          }
        }
      };
  ...
  const downloadTxt = () => {
    const blob = new Blob([textExportData], {
      type: 'text/plain'
    });
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
  ...
  }, "v23")), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      alignItems: 'center',
      gap: 12
    ...
    size: 12,
    color: "#FFD700"
  }), " ", user?.xp || 0, " XP"), /*#__PURE__*/React.createElement("span", {
    style: {
      color: 'var(--black)',
      fontWeight: 'bold',
      display: 'flex',
    ...
    size: 14,
    color: "var(--black)"
  })), " ", streak, " DAY STREAK"))), showBackup && /*#__PURE__*/React.createElement("div", {
    style: {
      position: 'fixed',
      inset: 0,
      zIndex: 2000,
  ...
  }, "YOUR DATA ARCHIVE"), /*#__PURE__*/React.createElement("button", {
    onClick: () => setShowBackup(false),
    style: {
      background: 'none',
      border: 'none',
  ...
  }), "DOWNLOAD .TXT"), /*#__PURE__*/React.createElement("button", {
    onClick: () => {
  ...
  }, "COPY JSON")), /*#__PURE__*/React.createElement("div", {
    style: {
      padding: '0 20px 8px'
    }
  }, /*#__PURE__*/React.createElement("div", {
  ...
  }, "RAW BACKUP DATA:")), /*#__PURE__*/React.createElement("textarea", {
    readOnly: true,
    value: backupData,
    style: {
      flex: 1,
...
const Header = ({
  ...
  return /*#__PURE__*/React.createElement("header", {
  ...
  }, /*#__PURE__*/React.createElement(DailyDropWidget, {
    onUsePrompt: onDailyDropUse,
    isHeaderMode: true
  })), !isArchive && !isMinimized && /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      alignItems: 'center',
      justifyContent: 'center',
  ...
  }, "\u2014 ", subtitle)), isArchive && /*#__PURE__*/React.createElement("div", {
    style: {
      width: '100%',
      maxWidth: 420
    }
  ...
  }, "ARCHIVE SEARCH"), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      alignItems: 'center',
      gap: 8,
  ...
  }), archiveQuery && /*#__PURE__*/React.createElement("button", {
    ...
    stroke: "var(--black)",
    strokeWidth: "0.8",
    className: isTyping ? 'animate-flash' : ''
  }), /*#__PURE__*/React.createElement("rect", {
    x: "17",
    y: "17.5",
    width: "5",
    ...
    fontWeight: "bold"
  }, "R"), /*#__PURE__*/React.createElement("circle", {
    cx: "15",
    cy: "29",
    r: "2.5",
    fill: "var(--black)",
...
const SocialExportModal = ({
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, formatDate(bar.created_at))), /*#__PURE__*/React.createElement("div", {
    style: {
      flex: 1,
      display: 'flex',
      flexDirection: 'column',
  ...
  }, "@GUAPDAD4000"), /*#__PURE__*/React.createElement("div", {
    style: {
  ...
  }, "DAILY BARS"))), /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 24,
      display: 'flex',
      gap: 12
    ...
    className: "animate-pulse"
  }, "GENERATING...")) : imageData ? /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("button", {
...
const IdeaCard = ({
  ...
  if (bar.imageUrl) {
    return /*#__PURE__*/React.createElement("article", {
    ...
    }, formatDate(bar.created_at), bar.aiGenerated && /*#__PURE__*/React.createElement("span", {
      style: {
        marginLeft: 6,
        background: 'var(--electric)',
        color: 'var(--black)',
      ...
      style: {
        color: bar.isFavorite ? 'var(--black)' : 'var(--light-gray)'
      }
    }, /*#__PURE__*/React.createElement(Icon, {
      name: "Star",
      size: 14
    ...
    }, bar.tags?.slice(0, 2).map((tag, i) => /*#__PURE__*/React.createElement("span", {
      key: i,
      style: {
        fontSize: 8,
        padding: '2px 6px',
  ...
  return /*#__PURE__*/React.createElement("article", {
  ...
  }, formatDate(bar.created_at), " \u2014 ", formatTime(bar.created_at), bar.aiGenerated && /*#__PURE__*/React.createElement("span", {
    style: {
      marginLeft: 6,
      background: 'var(--electric)',
      color: 'var(--black)',
  ...
  }, showAddCaptionCta ? /*#__PURE__*/React.createElement("span", {
    style: {
      display: 'inline-flex',
      alignItems: 'center',
      gap: 6,
    ...
    name: "Edit3",
    size: 14
  }), " ADD CAPTION TO THIS VOICE NOTE") : bar.text), bar.tags?.length > 0 && /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      gap: 6,
      marginTop: 12,
  ...
  }, "#", tag))), bar.audioUrl && /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 12
    }
    ...
    name: "Share2",
    size: 12
  }), " POST THAT"), /*#__PURE__*/React.createElement("button", {
    onClick: () => onAddToCrate && onAddToCrate(bar),
    style: {
      color: 'var(--crates-blue)',
      display: 'flex',
      alignItems: 'center',
      gap: 4,
      fontSize: 9,
    ...
    name: "Disc",
    size: 12
  }), " CRATE"), onSendToFreeGame && /*#__PURE__*/React.createElement("button", {
    ...
    name: "Trash2",
    size: 14
  }))), showExport && /*#__PURE__*/React.createElement(SocialExportModal, {
    bar: bar,
    onClose: () => setShowExport(false)
  }), showFreeGameConfirm && /*#__PURE__*/React.createElement("div", {
    style: {
      position: 'fixed',
      inset: 0,
  ...
  }, "CONFIRM FREE GAME?"), /*#__PURE__*/React.createElement("p", {
    style: {
      fontSize: 11,
      lineHeight: 1.5,
      marginBottom: 20
    }
  }, "This will post your bar to the public Free Game feed for anyone to use. You will still keep this copy in your personal feed."), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      gap: 10
    }
  }, /*#__PURE__*/React.createElement("button", {
    onClick: () => setShowFreeGameConfirm(false),
    style: {
      flex: 1,
      padding: 12,
      border: '2px solid var(--black)',
    ...
    onClick: () => {
      onSendToFreeGame(bar);
      setShowFreeGameConfirm(false);
    },
    style: {
      flex: 1,
      padding: 12,
...
const RhymePopup = ({
  ...
  useEffect(() => {
    const loadRhymes = async () => {
      setLoading(true);
      const [exactRhymes, nearRhymeResults, synonymResults] = await Promise.all([fetchRhymes(word), fetchNearRhymes(word), fetchSynonyms(word)]);
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, "\uD83E\uDDE0 RHYMES FOR \"", word.toUpperCase(), "\""), /*#__PURE__*/React.createElement("button", {
    onClick: onClose,
    style: {
      padding: 2
    }
    ...
    className: "animate-pulse"
  }, "FINDING RHYMES...")) : /*#__PURE__*/React.createElement(React.Fragment, null, rhymes.length > 0 && /*#__PURE__*/React.createElement("div", {
    style: {
      marginBottom: 12
    }
  }, /*#__PURE__*/React.createElement("div", {
  ...
  }, "PERFECT RHYMES"), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      flexWrap: 'wrap',
      gap: 4
    }
  }, rhymes.map((rhyme, i) => /*#__PURE__*/React.createElement("button", {
    key: i,
    onClick: () => {
      onSelect(rhyme);
      haptic('light');
  ...
  }, rhyme)))), nearRhymes.length > 0 && /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 8,
      color: 'var(--gray)',
      letterSpacing: '0.1em',
  ...
  }, "NEAR RHYMES"), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      flexWrap: 'wrap',
      gap: 4
    }
  }, nearRhymes.map((rhyme, i) => /*#__PURE__*/React.createElement("button", {
    key: i,
    onClick: () => {
      onSelect(rhyme);
      haptic('light');
  ...
  }, rhyme)))), synonyms.length > 0 && /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 12
    }
  }, /*#__PURE__*/React.createElement("div", {
  ...
  }, "SYNONYMS"), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      flexWrap: 'wrap',
      gap: 4
    }
  }, synonyms.map((syn, i) => /*#__PURE__*/React.createElement("button", {
    key: i,
    onClick: () => {
      onSelect(syn);
      haptic('light');
  ...
  }, syn)))), rhymes.length === 0 && nearRhymes.length === 0 && synonyms.length === 0 && /*#__PURE__*/React.createElement("div", {
    style: {
      padding: 20,
      textAlign: 'center',
      color: 'var(--gray)',
  ...
  }, "NO RHYMES FOUND", /*#__PURE__*/React.createElement("br", null), /*#__PURE__*/React.createElement("span", {
    style: {
      fontSize: 9
    }
...
const QuickInput = ({
  ...
  if (!expanded) {
    ...
    }, "DROP A BAR..."), /*#__PURE__*/React.createElement("div", {
      style: {
        width: 36,
        height: 36,
        background: 'var(--electric)',
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, (isRecording || audioUrl || savedAudioUrl) && /*#__PURE__*/React.createElement("div", {
    style: {
  ...
  }, Math.floor(duration / 60), ":", (duration % 60).toString().padStart(2, '0')), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      alignItems: 'center',
      gap: 6,
  ...
  }, window.MicVisualizer && /*#__PURE__*/React.createElement(window.MicVisualizer, {
    stream: stream,
  ...
  })))) : savedAudioUrl ? /*#__PURE__*/React.createElement("div", {
    style: {
      width: '100%',
      display: 'flex',
      flexDirection: 'column',
  ...
  }, "VOICE MEMO ATTACHED")), /*#__PURE__*/React.createElement("button", {
    onClick: () => setSavedAudioUrl(null),
    style: {
      padding: 6,
      color: 'var(--gray)',
      background: 'transparent',
  ...
  })) : audioUrl && /*#__PURE__*/React.createElement("div", {
    style: {
      width: '100%',
      display: 'flex',
      flexDirection: 'column',
  ...
  }, "REDO")))), recordError && /*#__PURE__*/React.createElement("div", {
    style: {
      background: '#FEE2E2',
      padding: 12,
      fontSize: 11,
  ...
  }, recordError, " - ENABLE MICROPHONE ACCESS"), !isRecording && !audioUrl && !savedAudioUrl && /*#__PURE__*/React.createElement("div", {
    style: {
      width: '100%',
      padding: '16px 12px',
  ...
  }, "TAP TO RECORD")), imageUrl ? /*#__PURE__*/React.createElement("div", {
    style: {
      position: 'relative'
    }
  }, /*#__PURE__*/React.createElement("img", {
    ...
    name: "Info",
    size: 10
  }), " RHYMES AUTO-HIGHLIGHTED \u2022 DOUBLE-TAP FOR SUGGESTIONS"), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      gap: 16,
      marginTop: 8,
  ...
  }, /*#__PURE__*/React.createElement("span", null, countBars(text), " BARS"), /*#__PURE__*/React.createElement("span", null, countWords(text), " WORDS"), savedAudioUrl && /*#__PURE__*/React.createElement("span", null, "\uD83C\uDF99\uFE0F MEMO"))), rhymePopup.show && /*#__PURE__*/React.createElement(RhymePopup, {
  ...
  }, "#", tag, " \xD7"))), /*#__PURE__*/React.createElement("input", {
    value: tagInput,
  ...
  }, aiLoading ? '...' : item.label))), /*#__PURE__*/React.createElement("div", {
    style: {
      padding: 16,
      display: 'flex',
      justifyContent: 'space-between',
  ...
  }, "MINIMIZE"), /*#__PURE__*/React.createElement("button", {
    onClick: handleSave,
    disabled: !text.trim() && !savedAudioUrl,
    style: {
      padding: '12px 24px',
      background: text.trim() || savedAudioUrl ? 'var(--black)' : 'var(--light-gray)',
      color: 'var(--white)',
      fontSize: 11,
      fontWeight: 700,
      letterSpacing: '0.1em'
...
const AddToCrateModal = ({
  ...
  }, "ADD TO CRATE"), /*#__PURE__*/React.createElement("button", {
    onClick: onClose,
    style: {
      color: 'var(--white)'
    }
  ...
  }, "SELECT A TRACK TO INSERT THIS BAR:"), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      flexDirection: 'column',
      gap: 8
  ...
  }, "START NEW TRACK")), songs.map(song => /*#__PURE__*/React.createElement("button", {
    key: song.id,
  ...
  }, formatDate(song.updated_at))))))), /*#__PURE__*/React.createElement("div", {
    style: {
      padding: 16,
      borderTop: '1px solid var(--light-gray)'
    }
...
const UserProfileModal = ({
  ...
  const loadTrophies = async () => {
    ...
    try {
      ...
      const {
        data,
        error
      } = await supabase.from('user_trophies').select('trophy_id, earned_at, earned_via').eq('user_id', user.id);
      if (!error) {
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, "@", user?.username?.toUpperCase()), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 9,
  ...
  }, "JOINED ", formatDate(user?.created_at))), /*#__PURE__*/React.createElement("button", {
    onClick: onClose,
    style: {
      background: 'transparent',
      border: 'none',
  ...
  }, user?.xp || 0), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 9,
      fontFamily: 'IBM Plex Mono',
      letterSpacing: '0.1em',
  ...
  }, "TOTAL XP")), /*#__PURE__*/React.createElement("div", {
    style: {
      background: 'rgba(255,255,255,0.9)',
      padding: 16,
      textAlign: 'center'
  ...
  }, user?.total_bars || 0), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 9,
      fontFamily: 'IBM Plex Mono',
      letterSpacing: '0.1em',
  ...
  }, "BARS WRITTEN")), /*#__PURE__*/React.createElement("div", {
    style: {
      background: 'rgba(255,255,255,0.9)',
      padding: 16,
      textAlign: 'center'
  ...
  }, user?.current_streak || 0), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 9,
      fontFamily: 'IBM Plex Mono',
      letterSpacing: '0.1em',
  ...
  }, user?.longest_streak || 0), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 9,
      fontFamily: 'IBM Plex Mono',
      letterSpacing: '0.1em',
  ...
  }, "SHOWCASE (PICK UP TO 3)"), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'grid',
    ...
    }, trophy ? hasImage ? /*#__PURE__*/React.createElement("img", {
    ...
    }, trophy.icon), /*#__PURE__*/React.createElement("div", {
      style: {
        fontSize: 7,
        fontFamily: 'IBM Plex Mono',
        textAlign: 'center',
    ...
    }, trophy.name)) : /*#__PURE__*/React.createElement("div", {
      style: {
        fontSize: 24,
        opacity: 0.2
      }
    ...
    return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
    ...
    }, /*#__PURE__*/React.createElement("span", null, "ACHIEVEMENTS"), /*#__PURE__*/React.createElement("span", {
      style: {
        fontSize: 9,
        color: 'var(--gray)'
      }
    }, earnedAchievements.length, "/", achievementTrophies.length)), /*#__PURE__*/React.createElement("div", {
      style: {
        display: 'grid',
        gridTemplateColumns: 'repeat(3, 1fr)',
        gap: 8
      ...
      }, trophy.name), !earned && trophy.requirementType && /*#__PURE__*/React.createElement("div", {
        style: {
          position: 'absolute',
          bottom: 4,
          fontSize: 6,
